...
public class GenericsDemo {
    public static void main(String[] args) {
        ...
        MyCollection<Number> c2 = new MyCollection<Number>();
        /**
...
//        https://stackoverflow.com/questions/2745265/is-listdog-a-subclass-of-listanimal-why-arent-javas-generics-implicitly-p
        ...
        MyCollection<? extends Number> c5 = new MyCollection<Number>();
        MyCollection<? extends Number> c6 = new MyCollection<Integer>();

        MyCollection<? super Number> c7 = new MyCollection<Number>();
        MyCollection<? super Number> c8 = new MyCollection<Object>();

//        MyCollection<?> c9 = new MyCollection<?>();
        //endregion

        //region showcase #3: generic method
        MyCollection.addToEach(1)
                .forEach(e -> e.intValue());
        //endregion
...
class MyCollection<T> {
    ...
    //region showcase #3: generic method
    public static <P> Collection<P> addToEach(P arg) { return null; }
    //endregion
